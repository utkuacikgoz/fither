...
//
//   finish → (unlock, if a skill landed) → intention → reminder ask → home
//
...
export type CloseAsk = "/intention" | "/reminder-ask";
 ...
 * (answered or declined) the same call yields the reminder ask.
 */
