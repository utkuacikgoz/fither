...
import { AvoidPage } from "../../src/screens/settings/pages/avoid-page";

// Settings → Always work around, pushed over the tabs from its row. Wears the
...
export default function SettingsAvoidPageRoute() {
