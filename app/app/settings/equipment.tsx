...
import { EquipmentPage } from "../../src/screens/settings/pages/equipment-page";

// Settings → Equipment, pushed over the tabs from its row. Wears the
...
export default function SettingsEquipmentPageRoute() {
